...
for i in files:
    ...
    if temp[-1] == "cpp":  # distinguo eventuali file cpp o h
        ...
        if ismodified(i):  # controllo che non sia gia stato compilato / non modificato
            ...
            # command = f"cl /c /ZI /EHsc /Foobjs\\{temp[0]}.obj /Fddebug\\{temp[0]}.pdb /Iinclude src\\{temp[0]}.cpp"

            command = f"g++ -g3 -std=c++11 -c -Wno-depreacated-declaration -Iinclude -Iext/stb_image -Iext/glm -Iext -Iext/glew/include -Iext/glfw/include -o .\\objs\\{temp[0]}.o .\\src\\{temp[0]}.cpp"
...
if len(out[1]) == 0:
    ...
    # command = f"LINK /OUT:..\\exe\\Game.exe /LIBPATH:C:\\Users\\Leonardo\\Desktop\\workspace\\libs\\libs-c++\\raylib-3.5-msvc\\lib\\"
